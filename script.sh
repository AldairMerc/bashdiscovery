...
curl $url -H 'User-Agent: Mozilla/5.0 (X11; Ubuntu; Linux x86_64; rv:124.0) Gecko/20100101 Firefox/124.0' | grep -o 'href="[^"#"]*"' |awk -F '"' '{if($2 !~ /^http/) print $url; else print $url $2}'| sort | uniq -u >> $file
