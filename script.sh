...
curl -I '$url' -H 'User-Agent: Mozilla/5.0 (X11; Ubuntu; Linux x86_64; rv:124.0) Gecko/20100101 Firefox/124.0' | grep -o 'href"[^"#"]"' | $url = $url awk -F '"' 'if ($2 !~ /http/) print $url; $2; else print $2}' | sort | uniq -u >> $file;
